// https://github.com/stefanprokopdev/verify-apple-id-token/blob/main/src/lib/verifyAppleIdToken.ts
...
export const getApplePublicKey = async (kid: string) => {
  ...
  // https://gitlab.com/JacoKoster/node-jwks-client#custom-headers
